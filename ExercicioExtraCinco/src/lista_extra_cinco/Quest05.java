...
ao usuário o valor da sua hora e a quantidade de horas trabalhadas no mês
	...
	public static void main(String[] args) {
		...
		float vHoraTrab, hTrab, sBruto, sLiquido, iRenda, fgts, sind, porIR, tDesc;
		...
		tDesc = iRenda + sind;
		sLiquido = sBruto - tDesc;
		
		System.out.printf("\n###########################################\n"
						+ "Salario Bruto: (R$%.2f * %.0f H) = R$%.2f\n"
				        + "(-) IR (%.0f) porcento:............ = R$%.2f\n"
				        + "(-) Sindicato (3) porcento:..... = R$%.2f\n"
				        + "FGTS (11) porcento:............. = R$%.2f\n"
				        + "Total de desconto:.............. = R$%.2f\n"
				        + "Salário liquido:................ = R$%.2f"
				        ,vHoraTrab, hTrab, sBruto, porIR, iRenda, sind, fgts, tDesc, sLiquido);
		read.close();
	}
}
